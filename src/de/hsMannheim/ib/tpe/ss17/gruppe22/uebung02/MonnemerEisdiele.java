...
public class KoelnerEisdiele extends Eisdiele{
	KoelnerEisdiele(){
		this.karte[0] = new KoelnerEis("Himbeer Becher", "Glas", "Bällchen",
		...
		this.karte[1] = new KoelnerEis("Bananasplit", "Schale", "Kugeln", new String[] { "Vanilleeis", "Bananeneis" },
				new String[] { "einer Banane", "Sahne", "Schokoladen-Kokos-Soße","Bierteigwaffeln" }, 7.10);
	...
	protected void kassieren(Eis eis) {
		System.out.println("Dat määt dann " + eis.getPreis() + "0€.");
	}
	...
	protected void verabschieden() {
		...
		switch (x) {
		case 1:
			System.out.println("Loße Se sich ehr Ies schmecke!");
			break;
		case 2:
			System.out.println("Ein schöne Dach noch!");
			break;
		case 3:
