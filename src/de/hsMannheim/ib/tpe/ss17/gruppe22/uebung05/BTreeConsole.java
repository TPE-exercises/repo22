...
public class BTreeConsole {
    ...
    private static int[] getValuesFromFile(String filepath) {
        if (isFilePresent(filepath)) {
            ...
            throw new MakeItSimple.GDIException("Filepath: " + filepath + " does not exists.");
        }
    }
    ...
    private static void creatingANewBTreePossibilities(int creatingBy) {
        ...
        switch (creatingBy) {
            ...
            case 1:
                ...
                break;
            default:
                println("Something goes wrong, by creating a BTree.");
                break;
        }
    }
    ...
    /**
     * This method calculates the exponent of an number Works only for positive
     * natural numbers, because the amount of a tree can only be positive.
     *
    ...
    private static int powRecursivelyForBTrees(int base, int exponent) {
        if (exponent == 1) {
            ...
            throw new MakeItSimple.GDIException("Method isn't set up for negative exponents.");
        } else {
        ...
        while (!exitProgramm) {
            ...
            switch (input) {
                ...
                case 4:
                    ...
                    insertIntoBTree(readInt());
                    break;
                case 5:
                    println("Which file do You wish to use?");
                    readLine();
                    String file = readLine();
                    insertIntoBTree(getValuesFromFile(file));
                    break;
                case 6:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    bTreeList[currentBTree].printInorder();
                    break;
                case 14:
                    bTreeList[currentBTree].printPostorder();
                    break;
                case 15:
                    bTreeList[currentBTree].printPreorder();
                    break;
                case 16:
                ...
                case 17:
                    bTreeList[currentBTree].sketchElementsOnConsole(); // TODO: move to Tree
                // printingElementsLevelordered(bTreeList[currentBTree].toStringLevelorder(), bTreeList[currentBTree].getOrder());
                case 18:
                    bTreeList[currentBTree].clone();
                    break; // TODO: clone to what tree?
                case 19:
